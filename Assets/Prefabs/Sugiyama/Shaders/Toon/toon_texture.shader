...
uniform lowp vec4 _InkSampler_ST;
...
void main ()
{
  ...
  tmpvar_16 = ((_glesMultiTexCoord0.xy * _InkSampler_ST.xy) + _InkSampler_ST.zw);
  tmpvar_2 = tmpvar_16;
...
void main ()
{
  gl_FragData[0] = texture2D (_InkSampler, xlv_TEXCOORD0);
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_3
eefiecedikongehmbhfpoeeipdeamlnophlcjideabaaaaaajeabaaaaaeaaaaaa
